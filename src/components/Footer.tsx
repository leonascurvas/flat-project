      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mb-8 md:mb-0">
            <Link href="/home" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">Home</Link>
            <Link href="/services" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">Sobre</Link>
            <Link href="/about" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">Quem Somos</Link>
            <Link href="/contact" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">Contato</Link>
          </div>

          {/* Social Media Icons */}
          <div className="flex space-x-4">
            {/* LinkedIn */}
            <Link href="#" aria-label="LinkedIn" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
            ...
            {/* Instagram */}
            <Link href="#" aria-label="Instagram" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
            ...
            {/* Facebook */}
            <Link href="#" aria-label="Facebook" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
            ...
            {/* TikTok */}
            <Link href="#" aria-label="TikTok" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
